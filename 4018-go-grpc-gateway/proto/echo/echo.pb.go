...
const file_proto_echo_proto_rawDesc = "" +
	...
	"\x03seq\x18\x02 \x01(\x03R\x03seq2\xe7\x01\n" +
	"\vEchoService\x12-\n" +
	...
	"\fClientStream\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse(\x01\x127\n" +
	"\n" +
	"BidiStream\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse(\x010\x01B!Z\x1fgrpc-gateway-example/proto/echob\x06proto3"
...
var file_proto_echo_proto_depIdxs = []int32{
	...
	0, // 1: echo.EchoService.ServerStream:input_type -> echo.EchoRequest
	0, // 2: echo.EchoService.ClientStream:input_type -> echo.EchoRequest
	0, // 3: echo.EchoService.BidiStream:input_type -> echo.EchoRequest
	1, // 4: echo.EchoService.Echo:output_type -> echo.EchoResponse
	1, // 5: echo.EchoService.ServerStream:output_type -> echo.EchoResponse
	1, // 6: echo.EchoService.ClientStream:output_type -> echo.EchoResponse
	1, // 7: echo.EchoService.BidiStream:output_type -> echo.EchoResponse
